 ...
 * @since Ultimate 1.0
 */
function ultimate_get_option_defaults() {
	...
	'site_design'											=> 'on',
	'slider_content'										=> 'on',
	'disable_background_image'							=> 0,
	'slider_background_image'									=> '',
	'disable_infobar_footer_background_image'		=> 0,
	'footer_infobar_background_image'				=> '',
	'disable_sitetitle_background_image'			=> 0,
	'sitetitle_background_image'						=> ''
 );
return apply_filters( 'ultimate_get_option_defaults', $array_of_default_settings);
}
?>
